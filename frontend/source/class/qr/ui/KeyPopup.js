...
qx.Class.define("qr.ui.KeyPopup", {
    ...
    events : { loginSucceeded : 'qx.event.type.Data' },
    ...
    members : {
        ...
        _addForm : function(cfg) {
            this.add(new qx.ui.basic.Label(this.tr('You Access Key has just been sent to the eMail address you provided in the previous dialog. Please enter the Access Key in the field below.')).set({ rich : true }));
